...
<p align="center">
  ...
  <img alt="downloads" src="https://img.shields.io/github/downloads/kzolotarev95/3xui-shopbot/total?label=downloads&style=flat-square">
  <img alt="license" src="https://img.shields.io/github/license/kzolotarev95/3xui-shopbot?label=license&style=flat-square">
  <img alt="last-commit" src="https://img.shields.io/github/last-commit/kzolotarev95/3xui-shopbot?label=last%20commit&style=flat-square">
  <img alt="issues" src="https://img.shields.io/github/issues/kzolotarev95/3xui-shopbot?label=issues&style=flat-square">
  <img alt="stars" src="https://img.shields.io/github/stars/kzolotarev95/3xui-shopbot?label=stars&style=flat-square">
...
```bash
curl -sSL https://raw.githubusercontent.com/MonopoD123/3xui-shopbot/main/install.sh | sudo bash
```
...
```bash
curl -sSL https://raw.githubusercontent.com/kzolotarev95/3xui-shopbot/main/install.sh | sudo bash
