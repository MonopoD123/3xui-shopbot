...
class BotController:
    ...
    def start(self):
        ...
        try:
            ...
            # Platega
            platega_merchant_id = database.get_setting("platega_merchant_id")
            platega_api_key = database.get_setting("platega_api_key")
            platega_enabled = bool(platega_merchant_id and platega_api_key)

            # URLPay
            urlpay_shop_id = database.get_setting("urlpay_shop_id")
            urlpay_api_key = database.get_setting("urlpay_api_key")
            urlpay_secret_key = database.get_setting("urlpay_secret_key")
            urlpay_enabled = bool(urlpay_shop_id and urlpay_api_key and urlpay_secret_key)
